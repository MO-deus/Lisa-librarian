...
sendMsg.addEventListener("click", () => {
  ...
  let chat_msg = message.value;
  if (chat_msg.startsWith("! Lisa")) {
    // console.log("msg for bot");
    ...
    socket.emit("new-message", {
      message: getBotRsp(message.value),
      username: "Lisa",
    });
